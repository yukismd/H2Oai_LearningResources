...
#### 画像データを用いたモデル作成（[動画](https://www.youtube.com/watch?v=e3CYgcumj_A)）（[資料](https://jp-public.s3.ap-southeast-1.amazonaws.com/documents/Workshop+(DAI+-+Image)+v231214.pdf)）
 - 画像データを利用した、回帰・分類問題
#### テキストデータを用いたモデル作成（[動画](https://www.youtube.com/watch?v=Ec200akQ8lw)）（[資料](https://h2oai-jpn-public.s3.amazonaws.com/docs/Workshop+(DAI+-+NLP)+v220317.pdf)）（[new 資料](https://jp-public.s3.ap-southeast-1.amazonaws.com/documents/Workshop+(DAI+-+NLP2)+v240107.pdf)）
